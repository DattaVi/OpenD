...
import { idlFactory } from './dtoken_backend.did.js';
export { idlFactory } from './dtoken_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DTOKEN_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dtoken_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dtoken_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dtoken_backend.did.js")._SERVICE>}
 */
export const dtoken_backend = createActor(canisterId);
